...
int ctp_trade_handle::ReqUserLogout(CThostFtdcUserLogoutField *pUserLogout, int nRequestID)
{
	return _api->ReqUserLogout(pUserLogout, nRequestID);
}	

int ctp_trade_handle::ReqUserPasswordUpdate(CThostFtdcUserPasswordUpdateField* pUserPasswordUpdate, int nRequestID)
{
